...
extension ArticleModelQueryWhere
  ...
  QueryBuilder<ArticleModel, ArticleModel, QAfterWhereClause> titleEqualTo(
      String title) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ArticleModel, ArticleModel, QAfterWhereClause> titleNotEqualTo(
      String title) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension ArticleModelQueryProperty
  ...
  QueryBuilder<ArticleModel, DateTime?, QQueryOperations>
      publishedAtProperty() {
    return QueryBuilder.apply(this, (query) {
